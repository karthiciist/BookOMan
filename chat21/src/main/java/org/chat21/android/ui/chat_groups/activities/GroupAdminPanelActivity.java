...
public class GroupAdminPanelActivity extends AppCompatActivity implements
    ...
    protected void onCreate(@Nullable Bundle savedInstanceState) {
        ...
        requestOptions.placeholder(R.drawable.ic_group_avatar);
        requestOptions.error(R.drawable.ic_group_avatar);
...
//        toolbarSubTitle.setText("");
        ...
        Glide.with(getApplicationContext())
                .load(chatGroup.getIconURL())
                .apply(new RequestOptions().placeholder(R.drawable.ic_group_avatar).error(R.drawable.ic_group_avatar))
                .into(mGroupImage);
